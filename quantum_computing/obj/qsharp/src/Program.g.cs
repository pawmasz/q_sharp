...
#line hidden
            {
#line 11 "C:\\GitLab\\q_sharp\\quantum_computing\\Program.qs"
                var q = Allocate__.Apply();
#line hidden
                bool __arg1__ = true;
                try
                {
#line 13 "C:\\GitLab\\q_sharp\\quantum_computing\\Program.qs"
                    Microsoft__Quantum__Intrinsic__H.Apply(q);
#line 16 "C:\\GitLab\\q_sharp\\quantum_computing\\Program.qs"
                    return M__.Apply(q);
                }
#line hidden
                catch
...
#line hidden
    ...
    [SourceLocation("C:\\GitLab\\q_sharp\\quantum_computing\\Program.qs", OperationFunctor.Body, 19, 32)]
    public partial class SampleRandomNumberInRange : Operation<Int64, Int64>, ICallable
    {
        ...
        {
            var max = __in__;
#line 20 "C:\\GitLab\\q_sharp\\quantum_computing\\Program.qs"
            var output = 0L;
#line 21 "C:\\GitLab\\q_sharp\\quantum_computing\\Program.qs"
            while (true)
            {
#line 22 "C:\\GitLab\\q_sharp\\quantum_computing\\Program.qs"
                var bits = QArray<Result>.Create(0L);
#line 23 "C:\\GitLab\\q_sharp\\quantum_computing\\Program.qs"
                foreach (var idxBit in new QRange(1L, Microsoft__Quantum__Math__BitSizeI.Apply(max)))
#line hidden
                {
#line 24 "C:\\GitLab\\q_sharp\\quantum_computing\\Program.qs"
                    bits = QArray<Result>.Add(bits, new QArray<Result>(GenerateRandomBit__.Apply(QVoid.Instance)));
                }

#line 26 "C:\\GitLab\\q_sharp\\quantum_computing\\Program.qs"
...
#line 28 "C:\\GitLab\\q_sharp\\quantum_computing\\Program.qs"
            return output;
        }
    ...
    [SourceLocation("C:\\GitLab\\q_sharp\\quantum_computing\\Program.qs", OperationFunctor.Body, 32, -1)]
    public partial class SampleRandomNumber : Operation<QVoid, Int64>, ICallable
    {
        ...
        {
#line 33 "C:\\GitLab\\q_sharp\\quantum_computing\\Program.qs"
            var max = 50L;
#line 34 "C:\\GitLab\\q_sharp\\quantum_computing\\Program.qs"
            Message__.Apply(String.Format("Sampling a random number between 0 and {0}: ", max));
#line 35 "C:\\GitLab\\q_sharp\\quantum_computing\\Program.qs"
